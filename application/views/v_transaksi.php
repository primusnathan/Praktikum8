	...
	<div class="col-md-7">
		...
		<table class="table table-hover table-stripped">
			...
			<thead>
				...
				<td>no</td><td>Nama Buah</td><td>Kategori</td><td>Harga</td><td>Stok</td><td>Beli</td><td></td><td></td>
			...
			<tbody>
				...
				<tr>
					...
					<td><?=$no?></td></td><td><?=$bk->nama_buah?></td><td><?=$bk->nama_kategori?></td><td><?=$bk->harga?></td><td><?=$bk->stok?></td>

					<td> <a href="<?=base_url('index.php/Cart/tambah_cart/'.$bk->kode_buku)?>" class="btn btn-success">Buy</a></td>
...
<table class="table table-stripped table-hover">
	...
	<tr><td colspan="2">Nama Pembeli</td><td colspan="4"><input type="text" name="pembeli" value="<?=$this->session->flashdata('pembeli');?>"></td></tr>
				...
				<th>No</th><th>Nama Buah</th><th>Jumlah</th><th>Harga</th><th>Subtotal</th><th></th>
		...
		<tr><td colspan="2">Pay</td><td colspan="4"><input type="number" name="bayaru"></td></tr>

		<tr><td colspan="2">Return</td><td colspan="4"><input type="number" value="<?= $this->session->flashdata('kembali') ?>" name="kembaliu"></td></tr>

		<tr><td colspan="2"><input type="submit" value="Pay" name="bayar" class="btn btn-success"></td><td colspan="2"><a href="<?=base_url('index.php/Cart/hapus_semua_cart')?>" class="btn btn-danger" onclick="return confirm('apakah anda yakin untuk menghapus semua pesanan')">Delete Cart</a></td><td colspan="2"><input type="submit" value="Update_qty" name="update qty" class="btn btn-primary"></td></tr>
